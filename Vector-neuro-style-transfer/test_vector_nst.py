...
from vector_nst import VectorNST
...
VectorNST(num_iter=num_iter, saving_verbose_lvl=saving_verbose_lvl, output_dir=results_folder).run_vector_nst(content_img_path, style_img_path)
